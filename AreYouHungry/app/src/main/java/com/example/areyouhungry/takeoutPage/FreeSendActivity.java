    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.linearlaout1:
                ...
                linearLayout1.setBackgroundColor(ContextCompat.getColor(FreeSendActivity.this, R.color.textcolor1));
                linearLayout2.setBackgroundColor(ContextCompat.getColor(FreeSendActivity.this, R.color.colorAccent));
                break;
            case R.id.linearlaout2:
                ...
                linearLayout1.setBackgroundColor(ContextCompat.getColor(FreeSendActivity.this, R.color.colorAccent));
                break;
